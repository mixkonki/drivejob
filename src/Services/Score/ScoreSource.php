...
final class ScoreSource
{
    ...
    public const ALL = [
        ...
        'insurance_record' => [
            ...
            'group' => self::GROUP_CREDENTIALS,
            'weight' => 30,
            // Ενεργό από 01/09: parser του Αναλυτικού Λογαριασμού e-ΕΦΚΑ,
            // δοκιμασμένος στα πραγματικά αρχεία του Κώστα (ΙΚΑ + ΤΕΒΕ + ΟΑΕΕ).
            // Καλύπτει ΚΑΙ αυτοαπασχολούμενους — τα ταμεία μη μισθωτών
            // είναι μέσα στο ίδιο export.
            'active' => true,
            'collector' => Collectors\InsuranceRecordCollector::class,
            'hint' => 'Ανέβασε τον Αναλυτικό Λογαριασμό Ασφάλισης από το gov.gr — μετράει και η αυτοαπασχόληση.',
        ],
