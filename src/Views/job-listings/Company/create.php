...
/**
 * Ενιαία φόρμα δημιουργίας αγγελίας από εταιρεία
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <h1 class="mb-4">Δημιουργία Αγγελίας Προσφοράς Εργασίας</h1>
                ...
                <div class="card-body">
                    <form action="<?= BASE_URL ?>job-listings/store" method="post" id="job-listing-form">
                        ...
                        <div class="form-group text-center mt-4">
                            ...
                            <a href="<?= BASE_URL ?>companies/profile" class="btn btn-secondary ml-2">Ακύρωση</a>
                        </div>
                    </form>
                </div>
            </div>
