...
/**
 * Ενιαία φόρμα δημιουργίας αγγελίας από χειριστή μηχανημάτων έργου
...
$pageTitle = 'Δημιουργία Αγγελίας Χειριστή Μηχανημάτων Έργου';
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <h1 class="mb-4">Δημιουργία Αγγελίας Χειριστή Μηχανημάτων Έργου</h1>

            <?php include ROOT_DIR . '/src/Views/partials/alerts.php'; ?>

            <div class="card">
                <div class="card-body">
                    <form action="<?= BASE_URL ?>job-listings/store-operator" method="post" id="job-listing-form">
                        ...
                        <!-- Επιλογή τύπου χειριστή -->
                        <div class="form-group mb-4">
                            <label for="job_category" class="form-label fw-bold">Τύπος Χειριστή *</label>
                            <select class="form-control form-select" id="job_category" name="job_category" required onchange="updateFormFields()">
                                <option value="">Επιλέξτε τύπο χειριστή</option>
                        ...
                        <div class="form-group text-center mt-4">
                            ...
                            <a href="<?= BASE_URL ?>operators/profile" class="btn btn-secondary ml-2">Ακύρωση</a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    // Ενημέρωση των πεδίων της φόρμας ανάλογα με τον επιλεγμένο τύπο χειριστή
    function updateFormFields() {
        ...
        if (jobCategory === 'machinery_operator') {
