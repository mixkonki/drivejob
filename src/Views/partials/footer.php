...
<?php
/*
 * ΤΟ FOOTER ΔΕΝ ΕΚΛΕΙΝΕ ΠΟΤΕ ΤΗ ΣΕΛΙΔΑ.
 *
 * Κάθε σελίδα του site έβγαινε χωρίς </body> και </html>. Οι browsers
 * το συγχωρούν και το διορθώνουν σιωπηλά, γι' αυτό δεν φαινόταν — αλλά
 * ένα HTML που δεν κλείνει είναι άκυρο, μπερδεύει τους crawlers της
 * Google, και σε ορισμένους readers οθόνης αφήνει το περιεχόμενο να
 * «κρέμεται» χωρίς τέλος.
 */
?>
</body>
</html>
