<?php
/**
 * View μηνυμάτων — μεταφέρθηκε αυτούσιο από το src/Legacy/companies-messages.php (Πακέτο 5.5).
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>companies/profile" class="btn btn-secondary">
                ...
                <?php if (empty($conversations)): ?>
                    <div class="empty-state">
                        ...
                        <p>Όταν οι οδηγοί επικοινωνήσουν μαζί σας, τα μηνύματα θα εμφανιστούν εδώ.</p>
                    </div>
                <?php else: ?>
                    <div class="conversations-list">
                        <?php foreach ($conversations as $conversation): ?>
                            <div class="conversation-item <?php echo $conversation['unread_count'] > 0 ? 'unread' : ''; ?>"
                                onclick="window.location.href='<?php echo BASE_URL; ?>companies/conversation?id=<?php echo $conversation['id']; ?>'">
                                    ...
                                    <div class="col-auto">
                                        <?php if ($conversation['profile_image']): ?>
                                            <img src="<?php echo BASE_URL . $conversation['profile_image']; ?>"
                                                ...
                                                class="driver-image">
                                        <?php else: ?>
                                            <div class="driver-image bg-secondary d-flex align-items-center justify-content-center text-white">
