...
<div class="container mt-4">
    <h1>Ταιριάσματα Αγγελίας Οδηγού</h1>

    <div class="card">
        <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Ταιριάσματα με Αγγελίες Εταιρειών</h5>
            <a href="/driver-listing/<?= $_GET['id'] ?? '' ?>/update-matches" class="btn btn-light btn-sm">Ενημέρωση Ταιριασμάτων</a>
        </div>
        <div class="card-body">
