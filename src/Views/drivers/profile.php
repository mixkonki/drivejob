                            ...
                            <?php foreach ($myListings['results'] as $listing) : ?>
                                <div class="listing-card">
                                    ...
                                    <div class="listing-actions">
                                        ...
                                        <a href="<?php echo BASE_URL; ?>job-listings/delete/<?php echo $listing['id']; ?>" class="btn-danger"
                                            onclick="return confirm('Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την αγγελία;')">Διαγραφή</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
