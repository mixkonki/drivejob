            ...
            <div class="tab-pane active" id="overview">
                ...
                <div class="profile-content">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <?php /* Γλώσσες & δεξιότητες ΕΔΩ (31/08): μετρημένο στη ζωντανή
                           σελίδα, η κύρια στήλη ήταν 2176px και η πλαϊνή 484px —
                           τα δύο τρίτα δεξιά κενά. Είναι σύντομες λίστες που
                           στέκονται σε στενή στήλη και ισορροπούν τη σελίδα. */ ?>
                        <?php include __DIR__ . '/_side-skills.php'; ?>
