                    ...
                    <div class="tab-pane" id="operator-licenses">
                        ...
                        <div class="license-section">
                            ...
                            <div id="operator_license_tab" class="license-details-tab <?php echo (!isset($driverOperator) || !$driverOperator) ? 'hidden' : ''; ?>">
                                ...
                                // η 11ετία εξηγείται ήδη στο hint του πεδίου ημερομηνίας.
                                echo \Drivejob\Helpers\RenewalAlerts::render(
                                    (isset($driverOperator) && $driverOperator) ? ($driverOperator['expiry_date'] ?? null) : null,
                                    \Drivejob\Helpers\RenewalAlerts::WINDOW_OPERATOR,
                                    'Η θεώρηση της άδειας χειριστή',
                                    'Η θεώρηση γίνεται στη Διεύθυνση Ανάπτυξης της Περιφέρειας σας.'
                                );
                                ?>
                            </div>
                        </div>
