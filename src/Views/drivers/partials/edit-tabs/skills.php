<?php /* Καρτέλα «skills» της φόρμας επεξεργασίας προφίλ — αποσπάστηκε από το edit-profile.php (Πακέτο 5.4).
   Μοιράζεται το scope μεταβλητών του γονικού view (include). */ ?>
            <div class="tab-pane" id="skills-tab">
                ...
                <?php /* Το id είναι ο προορισμός του συνδέσμου «Επεξεργασία» από
                   την καρτέλα προσόντων του προφίλ (#skills-tab~dj-skills):
                   ανοίγει την καρτέλα ΚΑΙ φωτίζει αυτή την ενότητα. (31/08) */ ?>
                <!-- Φόρμα δεξιοτήτων -->
                <div class="form-section" id="dj-skills">
