...
use PDO; // <-- Προσθήκη use statement αν χρειάζεται για το type hint
...
class JobListingController {
    ...
    public function __construct(PDO $pdo) { // <-- Προσθήκη PDO type hint (προαιρετικά αλλά καλή πρακτική)
        $this->pdo = $pdo;
...
private function getSimilarListings($currentListingId, $ownerId = null, $ownerType = null, $limit = 3) {
    ...
    } else if (!empty($currentListing['location'])) {
