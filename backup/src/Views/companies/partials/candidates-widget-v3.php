...
/**
 * AI Candidates Widget για το Company Dashboard - Version 3
 * Διορθωμένο για να στέλνει cookies με το AJAX request
 */
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        `;
            ...
            // ΣΗΜΑΝΤΙΚΟ: Προσθήκη credentials: 'same-origin' για να στέλνονται τα cookies
            fetch(`<?php echo BASE_URL; ?>api/matching/job/candidates/index.php?job_id=${jobId}&limit=5`, {
                    method: 'GET',
                    credentials: 'same-origin', // Αυτό είναι το κλειδί!
                    headers: {
