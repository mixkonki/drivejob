    ...
    <div class="container">
        ...
        <div class="profile-content">
            <div class="profile-main">
                ...
                <!-- Νέα Sections με Components -->
                <section class="profile-section">
                    <h2>Λειτουργίες & Υπηρεσίες</h2>
            ...
            <div class="profile-sidebar">
                ...
                <section class="profile-section">
                    ...
                    <?php else : ?>
                        <p class="profile-empty">Δεν έχετε καταχωρήσει υπεύθυνο επικοινωνίας. <a href="<?php echo BASE_URL; ?>companies/edit-profile">Προσθέστε τώρα!</a></p>
                    <?php endif; ?>
                </section>
