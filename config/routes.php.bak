...
// Νέες διαδρομές για τις ξεχωριστές φόρμες οδηγών και επιχειρήσεων
$router->get('/job-listings/create-driver', 'JobListingController@createDriverListing');
$router->get('/job-listings/create-company', 'JobListingController@createCompanyListing');
$router->get('/job-listings/edit-driver/{id}', 'JobListingController@editDriverListing');
$router->post('/job-listings/update/{id}', 'JobListingController@update');

// Διαδρομή για το δημόσιο προφίλ οδηγού
$router->get('/drivers/profile/{id}', 'DriversController@publicProfile');
// Διαδρομή για τις αγγελίες ενός συγκεκριμένου οδηγού
$router->get('/job-listings/driver/{id}', 'JobListingsController@driverListings');
$router->get('/αγγελιες/οδηγος/{id}', 'JobListingsController@driverListings');

$router->get('/job-listings/delete/{id}', [JobListingController::class, 'delete']);
$router->post('/job-listings/destroy/{id}', [JobListingController::class, 'destroy']);

$router->get('/drivers/edit-resume', 'DriverResumeController@editResume');
