...
<main>
    ...
    <section class="welcome">
        ...
        <p>Το DriveJob προσφέρει λογισμικό για τη διαχείριση πληρωμών, αδειών και πιστοποιήσεων. Αξιοποιήστε τη δύναμη των εργαλείων μας για να εξοικονομήσετε χρόνο και να αυξήσετε την παραγωγικότητα.</p>
    </section>
</main>
