...
<main>
    <div class="container">
        ...
        <div class="breadcrumbs">
            <a href="<?php echo BASE_URL; ?>drivers/driver-profile">Προφίλ</a> &gt;
            <a href="<?php echo BASE_URL; ?>drivers/edit-profile">Επεξεργασία Προφίλ</a> &gt;
        ...
        <?php if (Session::has('confirm_delete_experience')): ?>
            <div class="alert alert-warning">
                ...
                <div style="margin-top: 10px;">
                    <form action="<?php echo BASE_URL; ?>drivers/update-vehicle-experience.php" method="POST">
                        <?php echo \Drivejob\Core\CSRF::tokenField(); ?>
                        <input type="hidden" name="confirm_delete" value="1">
                        <button type="submit" class="btn-danger">Διαγραφή όλων των εγγραφών</button>
                        <a href="<?php echo BASE_URL; ?>drivers/vehicle-experience" class="btn-secondary">Ακύρωση</a>
                    </form>
                </div>
            </div>
        ...
        <form action="<?php echo BASE_URL; ?>drivers/update-vehicle-experience.php" method="POST" enctype="multipart/form-data" id="vehicleExperienceForm">
            <?php echo \Drivejob\Core\CSRF::tokenField(); ?>
            ...
            <div class="form-actions top-actions">
                <div class="form-buttons">
                    ...
                    <a href="<?php echo BASE_URL; ?>drivers/edit-profile" class="btn-secondary">Επιστροφή στην Επεξεργασία Προφίλ</a>
                </div>
            </div>

            <!-- Ενσωμάτωση του vehicle_experience.php -->
            <?php include ROOT_DIR . '/src/Views/drivers/vehicle-experience.php'; ?>
        </form>
    </div>
</main>
