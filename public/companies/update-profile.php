...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: ' . BASE_URL . 'companies/edit-profile.php');
    exit();
}
...
$companyModel = new \Drivejob\Models\Company\CompaniesModel($pdo);
...
header('Location: ' . BASE_URL . 'companies/company-profile.php');
exit();
