...
// Test 7: Check match_history table
echo "<h3>7. Checking match_history table...</h3>";
$stmt = $pdo->query("SELECT COUNT(*) as count FROM match_history");
$count = $stmt->fetch(PDO::FETCH_ASSOC);
echo "Match history records: " . $count['count'] . "<br>";

// Test 8: Check match_preferences table
echo "<h3>8. Checking match_preferences table...</h3>";
$stmt = $pdo->query("SELECT COUNT(*) as count FROM match_preferences");
$count = $stmt->fetch(PDO::FETCH_ASSOC);
echo "Match preferences records: " . $count['count'] . "<br>";
