                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <a href="ai-settings.php" class="admin-button">
            ...
            <div class="card-body p-4">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <a href="../test-ai-system.php" class="admin-button w-100 text-center">
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="index.php" class="admin-button w-100 text-center">
